...
def grounding_loss(cls_emb_pred, gt_caption_embs, temperature):
    ...
    '''
    cls_emb_pred = cls_emb_pred.unsqueeze(1)
    gt_caption_embs = gt_caption_embs.unsqueeze(1)
    batch_size, num_queries, d_l = cls_emb_pred.shape
    num_tokens = torch.ones(1).to(cls_emb_pred.device)
