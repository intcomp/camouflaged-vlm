...
from typing import Optional, Tuple, Type, Any, List, Dict
...
class ImageEncoderViTXdecoder(nn.Module):
    def __init__(
        self,
        img_size: int = 1024,
        patch_size: int = 16,
        ...
        self.neck = SimpleFPN(in_dim=embed_dim, out_dims=neck_out_dims)
    ...
    def forward(self, x: torch.Tensor) -> Dict[Any, Any]:
        inp = x
